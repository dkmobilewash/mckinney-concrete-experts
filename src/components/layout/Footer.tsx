...
export default function Footer() {
  ...
  const socialEntries = Object.entries(business.social).filter(
    ([, url]) => Boolean(url)
  );
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              Licensed, insured, and serving McKinney and Collin County with
              quality concrete work since {business.foundingYear}.
            </p>
            {business.license && (
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a
                  ...
                  className="flex items-start gap-3 text-sm text-gray-400 hover:text-accent transition-colors"
                >
